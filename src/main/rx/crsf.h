...
enum {
    CRSF_COMMAND_FRAME_DESTINATION = 0,
    CRSF_COMMAND_FRAME_ADDRESS,
    CRSF_COMMAND_FRAME_ID,
    CRSF_COMMAND_FRAME_PAYLOAD,
    CRSF_COMMAND_FRAME_CRC // + payload length
};

enum {
    CRSF_COMMAND_ID_FC = 0x01,
    CRSF_COMMAND_ID_BLUETOOTH = 0x03,
    CRSF_COMMAND_ID_OSD = 0x05,
    CRSF_COMMAND_ID_VTX = 0x08,
    CRSF_COMMAND_ID_LED = 0x09
};

enum {
    CRSF_COMMAND_ID_FC_LENGTH = 1,
    CRSF_COMMAND_ID_BLUETOOTH_LENGTH = 2,
    CRSF_COMMAND_ID_OSD_LENGTH = 2,
    CRSF_COMMAND_ID_VTX_LENGTH = 3,
    CRSF_COMMAND_ID_LED_LENGTH = 7
};
